  ...
  <div class="container">
    ...
    <section class="tools-row">
      ...
      <div class="tool tool--btn">
        <button id="reset" class="pill pill--ghost" type="button">
          Réinitialiser
        </button>
      </div>
    ...
    <section class="teachers-layout">
      ...
      <aside class="sidebar">
        ...
        <p class="sidebar-sub">
          Cliquez sur un enseignant pour voir ses créneaux.
        </p>


        <div class="slots" id="slots">
          <div class="slot-empty">
            Sélectionnez un enseignant dans la liste.
          </div>
        </div>
...
<script>
/* TON SCRIPT ORIGINAL CONSERVÉ — inchangé */
const teachers = [
  {
    id: "t1",
    nom: "Mme Dubois",
